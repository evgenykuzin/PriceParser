...
public class DataManagerFactory {
    ...
    private static WebCsvDataManager webCsvDataManager;

    public static WebCsvDataManager getOzonWebCsvManager() {
        if (webCsvDataManager == null) {
            try {
                Comparator<Table.Row> comparator = Comparator.comparingDouble(DataManagerFactory::getDiffPricesInt);
                Comparator<Table.Row> supComparator = (o1, o2) -> {
                ...
                webCsvDataManager = new WebCsvDataManager("credentials.json",
