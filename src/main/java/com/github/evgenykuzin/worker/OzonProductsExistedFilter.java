...
public class OzonProductsExistedFilter implements Runnable {
    ...
    private static final String CHILDREN_PRODUCTS_CATEGORY_SEARCH_URL = "https://www.ozon.ru/search/?page=%d&text=%s&from_global=true&category=7000";
    private static final double BOTTOM_LIMIT_PRICE = 250.0;

    OzonProductsExistedFilter() {
        DataManager dataManager = DataManagerFactory.getMyragToysCsvManager(INPUT_FILE);
